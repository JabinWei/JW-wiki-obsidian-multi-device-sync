...
![[90-Storage/98-Asset-资源/CoverImage/PY003-内置函数/Python内置函数-coverImage-v1.png|banner]]
...
![[90-Storage/98-Asset-资源/ArticleIllustrator/PY003-内置函数/01-framework-builtin-functions.png|Python 内置函数六大分类]]
...
> [!info] 银行家舍入
> 传统的”四舍五入”在处理尾数为 5 时**永远向上进位**，金融系统中成千上万笔交易的微小误差会不断累积。银行家舍入则让尾数为 5 时一半进位、一半舍去，从概率上抵消累积误差。
