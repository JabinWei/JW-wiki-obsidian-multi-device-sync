...
![[90-Storage/98-Asset-资源/CoverImage/PY004-关键字/Python关键字-coverImage-v1.png|banner]]
...
截至 Python 3.12，共有 **个**核心关键字。为了让你不再死记硬背，我将它们按功能分成了六类。
...
![[90-Storage/98-Asset-资源/ArticleIllustrator/PY004-关键字/01-framework-keyword-categories.png|Python 关键字六大分类]]
