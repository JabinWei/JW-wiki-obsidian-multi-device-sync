...
![[90-Storage/98-Asset-资源/CoverImage/PY017-回调函数/Python回调函数-coverImage-v1.png|banner]]
...
**异步回调**：在处理耗时任务（如网络请求、文件读写）时，为了不阻塞主线程，我们通常使用回调。
